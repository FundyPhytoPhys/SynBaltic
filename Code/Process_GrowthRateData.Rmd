...
MultiCultiGrowth %>%
  ...
  filter(Par_ue == 900) %>% 
  # filter(Strain == "PE-rich_120" | Strain == "PE-rich_132" | Strain == "PC-rich_060" | Strain == "PC-rich_124")  %>% 
...
MultiCultiGrowth %>%
  ...
  filter(Par_ue == 600) %>% 
  # filter(Strain == "PE-rich_048" | Strain == "PE-rich_127" | Strain == "PC-rich_056" | Strain == "PC-rich_077") %>% 
