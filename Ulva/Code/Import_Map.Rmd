...
worldGB<-world %>% 
  filter(region == "Canada" | region == "USA" | region == "Japan" | region == "Germany" | region == "Poland" | region == "UK"| region == "Finland"| region == "Israel"| region == "Panama"| region == "Portugal"| region == "Sweden"| region == "Norway")
...
```{r Create plot, fig.height = 6, fig.width = 10}
 ...
 Karolina %>%
  ...
  scale_x_continuous(breaks=seq(1987, 2026, by = 1)) +
...
gs4_deauth()
# this is the URL or ID of a Sheet readable by anyone (with a link)
Marcelina <- read_sheet("https://docs.google.com/spreadsheets/d/17rwTOA3wrkO7SMoUjeVK0_swOMMMbdMq4OKVNK_ctpM/edit?gid=1136803630#gid=1136803630")           
```
...
```{r Create plot, fig.height = 6, fig.width = 10}
 ...
 Marcelina %>%
  ggplot() +
  geom_point(aes(x = Rok_M, y = Suma_M, fill = as.factor(Rok_M)), fill = "darkslategray", show.legend = F, size = 7, shape=21, stroke=0.8, colour = "black") +
  geom_segment(aes(x = Rok_M, xend = Rok_M, y = 0, yend = Suma_M)) +
  ...
  #scale_fill_manual(values = c("Heterotrophs" ="burlywood3", "Algae" ="darkcyan", "Animals" ="coral4")) +
  labs(y = "Number of articles", x = "Year of publication") +
  # ggh4x::facet_nested(cols = vars(factor(Rok_M, levels=c("2025", "2015-2024", "2005-2014", "1995-2004", "1985-1994", "1975-1984", "1965-1974", "1955-1964", "1945-1954", "1935-1944", "1944"))), labeller = label_parsed) +
  geom_hline(yintercept=0) +
  coord_flip() +
    theme_bw() +
     theme(panel.grid.minor = element_blank(),
